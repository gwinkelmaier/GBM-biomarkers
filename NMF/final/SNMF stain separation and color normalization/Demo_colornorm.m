...
source=imread('/home/gwinkelmaier/parvin-labs/Histology/tests/NMF/data/Images/image4.bmp');
target=imread('images/target2.png');
% target=imread('/home/gwinkelmaier/parvin-labs/Histology/tests/NMF/data/Images/image13.bmp');
