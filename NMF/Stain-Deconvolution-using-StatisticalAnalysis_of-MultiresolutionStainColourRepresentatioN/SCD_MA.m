...
%     figure,subplot(141);imagesc(I);axis off, title('Source');
%     set(gcf,'units','normalized','outerposition',[0 0 1 1]);
%    
%    subplot(142),imagesc(H);axis off, title('S1');
%     set(gcf,'units','normalized','outerposition',[0 0 1 1]);
% 
%    subplot(143),imagesc(E);axis off, title('S2');
%     set(gcf,'units','normalized','outerposition',[0 0 1 1]);
% 
%     subplot(144),imagesc(Bg);axis off, title('S3');
%     set(gcf,'units','normalized','outerposition',[0 0 1 1]);
